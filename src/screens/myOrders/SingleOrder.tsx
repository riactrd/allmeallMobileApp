...
const SingleOrder = () => {
  ...
  const { data } = useGetmyorderIdQuery(orderId);
  useEffect(() => {
    if (id) {
      setOrderId(id);
    }
      ...
      <View style={styles.wrapper}>
        <View style={styles.headerContainer}>
          ...
          >
            <Text
              style={[
                selected === "1" ? styles.headertextActive : styles.headertext,
              ]}
            >
              Order Details
            </Text>
          ...
          >
            <Text
              style={[
                selected === "2" ? styles.headertextActive : styles.headertext,
              ]}
            >
              Renewal Orders
            </Text>
                  ...
                  {orderItems.map((item, index) => (
                    <View style={styles.itemsDetails} key={index}>
                      ...
                      >
                        ...
                        {item.pictures.slice(0, 1).map((picture, picIndex) => (
                    ...
                    <View style={styles.itemsDetails}>
                      ...
                      >
                        ...
                        <View style={{ marginLeft: 11 }}>
                          ...
                          <Text style={styles.itemtext}>{glassware.name}</Text>
                          <Text style={styles.itemtextTotal}>
