    ...
    <View style={styles.container}>
        <View style={styles.wrapper}>
            <View style={styles.containerheaderText}>
                <Text style={styles.headerText}>All Meal Prep Fequently Asked Questions</Text>
            </View>
                ...
                <View style={styles.adressesContainerItem}>
                    <View style={styles.containerItem}>
                        <View style={styles.headerTextButtom}>
                            <Text style={styles.headerTextItem}>What is All Meal Prep?</Text>
                    ...
                    <View style={styles.containerItem}>
                        <View style={styles.headerTextButtom}>
                            <Text style={styles.headerTextItem}>How fresh is All Meal Prep</Text>
