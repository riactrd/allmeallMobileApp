...
import { useIncreaseCartMutation, useDecreaseCartMutation, useDeleteItemCartMutation } from '../../../redux/api/myCartApi';
...
const MycartItem: FunctionComponent<Props> = ({item, refreshdata, index, increaseCart, decreaseCart, DeleteIteCart, increseSuccess, descreseSuccess,deleteSuccess }) => {
        ...
        <View style={styles.wrapper}>
           ...
           <View style={styles.ButtomContainer}>
                ...
                <View style={styles.bottomDelete}>
                  <Text style={styles.headerButtomText}>Sub Total: ${item.sub_total.toFixed(2)}</Text>
