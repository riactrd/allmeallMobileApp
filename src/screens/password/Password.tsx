          ...
          <View style={styles.viewScroll}>
            <View style={styles.inputContainer}>
              <Text style={styles.headerTextInput}>
                Old Password<Text style={{ color: mainColor }}>*</Text>
              </Text>
              <TextInput
                value={password.oldPassword}
                onChange={onChangeOldPassword}
                placeholder="Type enter Old Password..."
                style={styles.input}
              />
            </View>
            <View style={styles.inputContainer}>
              <Text style={styles.headerTextInput}>
                New Password<Text style={{ color: mainColor }}>*</Text>
              </Text>
              <TextInput
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.headerTextInput}>
                Confirm New Password<Text style={{ color: mainColor }}>*</Text>
              </Text>
              <TextInput
