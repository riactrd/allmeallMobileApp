...
const PickupItem: FunctionComponent = ({ item }) => {
  const navigation = useNavigation();
  const [deletePickup, { data: cancel, isLoading, error }] =
    useDeletpickupGlasswareMutation();
      ...
      <View style={styles.wrapper}>
        ...
        <View style={styles.textDivide}>
          <MaterialIcons
            ...
            style={styles.icon}
          />
          <Text style={styles.textDivideFontSub}>{item.requested_date}</Text>
        </View>
        <View style={styles.textDivide}>
