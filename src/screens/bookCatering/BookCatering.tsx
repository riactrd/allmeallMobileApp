...
const BookCatering = () => {
  ...
  // First side
  const [selectedFirstside, setSelectedFirstside] =
    useState("Select first side");
  const [modalFirstSide, setModalFirstSide] = useState(false);

  // second side
  const [selectedSecondside, setSelectedSecondside] =
    useState("Select second side");
            ...
            <View style={styles.viewScroll}>
              <View style={styles.inputContainerHeader}>
                <Text style={styles.textHeader}>
                  In order to make a Catering reservation please fill out the
                  form
                </Text>
              </View>
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  placeholder="Minimum Value is 15..."
                  style={styles.input}
                />
              </View>
              <View style={styles.inputContainer}>
              ...
              <TouchableOpacity activeOpacity={0.7} style={styles.addButtom}>
                <MaterialIcons
                  name="add-circle"
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  placeholder="4566-2222-3333-4532"
                  keyboardType="number-pad"
                  style={styles.input}
                />
              </View>
